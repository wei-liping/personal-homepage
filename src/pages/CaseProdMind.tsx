  ...
  return (
    ...
    >
      <Section icon="📌" title="项目概述（Overview）">
        <p>
          ProdMind AI 是一个面向产品经理的 AI 工作台，帮助用户把模糊想法与零散反馈转化为结构化产品决策。
        </p>
      ...
      <Section icon="🎯" title="Problem（用户问题）">
        ...
        <ul className="list-disc list-inside mt-2 space-y-1 text-slate-400">
          <li>场景 1：用户洞察在一个工具里，PRD 在另一个工具里，信息反复搬运</li>
      ...
      <Section icon="🧠" title="Key Design / System（核心设计）">
        ...
        <div className="space-y-3 mt-2">
          <div className="rounded-lg border border-white/5 bg-white/[0.02] p-4">
            <p className="text-sm text-slate-200 font-medium mb-1">模块 1：用户洞察提取</p>
            <p className="text-xs text-slate-400">将想法/评论结构化为痛点、情绪、需求关键词。</p>
          </div>
          <div className="rounded-lg border border-white/5 bg-white/[0.02] p-4">
            <p className="text-sm text-slate-200 font-medium mb-1">模块 2：PRD 生成与范围拆分</p>
            <p className="text-xs text-slate-400">自动产出 Persona、场景、功能并区分 MVP 与后续迭代。</p>
          </div>
          <div className="rounded-lg border border-white/5 bg-white/[0.02] p-4">
            <p className="text-sm text-slate-200 font-medium mb-1">模块 3：优先级与验证</p>
            <p className="text-xs text-slate-400">通过 RICE 排序和用户访谈模拟完成决策闭环。</p>
          </div>
        </div>
        <p className="text-slate-300 font-medium">
      ...
      <Section icon="🔄" title="Reflection（反思）">
        <p>
          我最大的收获是：AI PM 产品的价值不在“写得更快”，而在“让关键决策更有依据”。
        </p>
